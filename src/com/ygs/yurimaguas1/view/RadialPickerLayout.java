package com.ygs.yurimaguas1.view;
...
public class RadialPickerLayout extends FrameLayout implements OnTouchListener {
	...
	private static final int HOUR_INDEX = CircleFragment.HOUR_INDEX;
	private static final int MINUTE_INDEX = CircleFragment.MINUTE_INDEX;
	private static final int AMPM_INDEX = CircleFragment.AMPM_INDEX;
	private static final int ENABLE_PICKER_INDEX = CircleFragment.ENABLE_PICKER_INDEX;
	...
	public void initialize(Context context, int initialHoursOfDay,
		...
		mHideAmPm = mAccessibilityManager.isTouchExplorationEnabled() ? true
				: mIs24HourMode;
		...
		String[] hoursTexts = new String[hours.length];
		String[] innerHoursTexts = new String[hours.length];
		String[] minutesTexts = new String[hours.length];
